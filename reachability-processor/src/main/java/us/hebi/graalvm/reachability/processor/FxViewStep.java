 ...
 * @since 25 Nov 2025
 */
public class FxViewStep extends RepeatedMetadataStep<ReachableFxView> {

    public FxViewStep(Supplier<ProcessingEnvironment> env) {
        super("fx-view", env, ReachableFxView.class, ReachableFxView.List.class);
    }

    @Override
    protected void processAnnotation(ConditionalMetadata metadata, TypeElement type, ReachableFxView annotation, AnnotationMirror mirror) {
        final var rootDir = getClassOutputDir();
